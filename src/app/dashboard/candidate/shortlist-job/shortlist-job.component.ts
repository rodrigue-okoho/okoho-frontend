...
@Component({
  selector: 'app-shortlist-job',
  templateUrl: './shortlist-job.component.html',
  styleUrls: ['./shortlist-job.component.scss']
})
export class ShortlistJobComponent implements OnInit{
  jobs?: IJob[];
  isLoading = false;
  totalItems = 0;
  item="Jobs"
